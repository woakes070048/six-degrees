...
const app = (
	<Router history={browserHistory}>
		<Route path="/" component={App}>{/*tells all pages to use this*/}
			{/*add new route elements inside the app route
			what will pace them where we injected this.props.children*/}
